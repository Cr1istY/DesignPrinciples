...
public class NormalVideoService implements IVideoUserService {
    private final UserGradeConfig config = UserGradeConfig.normal();


    @Override
    public GradeResult serveGrade() {
        return GradeResult.builder().
                userLevel(UserType.NORMAL.getDisplayName()).
